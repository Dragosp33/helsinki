...
sequenceDiagram;
    ...
    Note right of the browser: The browser comes back to https://studies.cs.helsinki.fi/exampleapp/notes using a redirect, and making all the initial requests again
